...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    var parsedItems = Object.values(items); // totalPrice = parsedItems.reduce((totalPrice, menuItem) => {
...
function updateDelCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/remove-item', pizza).then(function (res) {
    cartCounter.innerText = res.data.totalQty;
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      type: 'success',
      timeout: 1000,
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
    var stripe, card, paymentType, paymentForm, loader;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            if (paymentForm) {
              //Loader Logic
              loader = document.querySelector('.cont');
...
__webpack_require__(/*! C:\Users\krish\OneDrive\Documents\Projects\responsive-pizza-app\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\krish\OneDrive\Documents\Projects\responsive-pizza-app\resources\scss\app.scss */"./resources/scss/app.scss");
